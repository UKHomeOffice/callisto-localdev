...
openssl x509 -req -CA ./ca.crt -CAkey ./ca.key -in $dir/$alias.csr -out $dir/$alias-ca-signed.crt -days $days -CAserial $dir/ca.srl -CAcreateserial -passin pass:$password
